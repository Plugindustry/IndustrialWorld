...
public final class ConstItem {
    @GeneratedItem(type = Material.WHEAT, instance = DummyItem.class, id = "grass")
    public static ItemStack GRASS;
    @GeneratedItem(type = Material.HAY_BLOCK, instance = DummyBlockItem.class, id = "grass_stack")
    public static ItemStack GRASS_STACK;
    @GeneratedItem(type = Material.WHEAT, instance = DummyItem.class, id = "hay")
    public static ItemStack HAY;
    @GeneratedItem(type = Material.HAY_BLOCK, instance = DummyBlockItem.class, id = "hay_stack")
    public static ItemStack HAY_STACK;
    @GeneratedItem(type = Material.FLINT_AND_STEEL, instance = DummyItem.class, id = "fire_starter")
    ...
    @GeneratedItem(type = Material.STONE, instance = DummyBlockItem.class, id = "malachite")
    ...
    @GeneratedItem(type = Material.GUNPOWDER, instance = DummyItem.class, id = "pure_crushed_malachite")
    public static ItemStack PURE_CRUSHED_MALACHITE;
    @GeneratedItem(type = Material.IRON_INGOT, instance = DummyItem.class, id = "raw_copper", oreDictionary = {
            "raw_copper"})
    public static ItemStack RAW_COPPER;

    @GeneratedItem(type = Material.GUNPOWDER, instance = DummyItem.class, id = "stone_powder")
    public static ItemStack STONE_POWDER;
    @GeneratedItem(type = Material.GUNPOWDER, instance = DummyItem.class, id = "quartz_powder")
    public static ItemStack QUARTZ_POWDER;

    @GeneratedItem(type = Material.WOODEN_AXE, instance = DummyItem.class, id = "wooden_hammer", oreDictionary = {
            "hammer"})
    public static ItemStack WOODEN_HAMMER;
    @GeneratedItem(type = Material.STONE_AXE, instance = DummyItem.class, id = "stone_hammer", oreDictionary = {
            "hammer"})
    public static ItemStack STONE_HAMMER;
    @GeneratedItem(type = Material.IRON_AXE, instance = DummyItem.class, id = "iron_hammer", oreDictionary = {
            "hammer"})
    public static ItemStack IRON_HAMMER;
    @GeneratedItem(type = Material.GOLDEN_AXE, instance = DummyItem.class, id = "golden_hammer", oreDictionary = {
            "hammer"})
    public static ItemStack GOLDEN_HAMMER;
    @GeneratedItem(type = Material.DIAMOND_AXE, instance = DummyItem.class, id = "diamond_hammer", oreDictionary = {
            "hammer"})
