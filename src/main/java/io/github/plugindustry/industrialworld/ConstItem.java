...
public final class ConstItem {
    ...
    @GeneratedItem(type = Material.IRON_INGOT, instance = DummyItem.class, id = "iw:raw_copper", oreDictionary = {
            "raw_copper"})
    ...
    @GeneratedItem(type = Material.WOODEN_AXE, instance = DummyItem.class, id = "iw:wooden_hammer", oreDictionary = {
            "hammer"})
    public static ItemStack WOODEN_HAMMER;
    @GeneratedItem(type = Material.STONE_AXE, instance = DummyItem.class, id = "iw:stone_hammer", oreDictionary = {
            "hammer"})
    public static ItemStack STONE_HAMMER;
    @GeneratedItem(type = Material.IRON_AXE, instance = DummyItem.class, id = "iw:iron_hammer", oreDictionary = {
            "hammer"})
    public static ItemStack IRON_HAMMER;
    @GeneratedItem(type = Material.GOLDEN_AXE, instance = DummyItem.class, id = "iw:golden_hammer", oreDictionary = {
            "hammer"})
    public static ItemStack GOLDEN_HAMMER;
    @GeneratedItem(type = Material.DIAMOND_AXE, instance = DummyItem.class, id = "iw:diamond_hammer", oreDictionary = {
            "hammer"})
